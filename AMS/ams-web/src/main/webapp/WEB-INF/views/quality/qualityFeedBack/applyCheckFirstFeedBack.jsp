...
<div class="easyui-layout" data-options="fit:true,border:true">
    <div data-options="region:'center'">
        <div id="feedbackProcess">
            ...
            <table>
                <div id="feedBackAttachmentBtn" class="padding_20 display_none"
                     onclose="reloadFeedBackAttachment()"></div>
            </table>
        </div>
        <div data-options="region:'south'"
             style="height: 30px;line-height:30px; overflow: hidden;text-align: right;background-color: #f3f3f3; border-top:1px solid #dddddd; color:#676767;">
